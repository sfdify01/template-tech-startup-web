...
const configData: Config = {
  name: "Tabsy SaaS",
  tagline: "Scale your business with our enterprise cloud platform.",
  ...
  seo: {
    title: "Tabsy SaaS | Premium Halal Meats & Groceries | Online Ordering",
    description: "Shop Tabsy SaaS for premium halal meats and groceries. Scale your business with our enterprise cloud platform. Order online for pickup or delivery today.",
    keywords: "halal meat, halal grocery, online ordering, food delivery, pickup, fresh market, halal butcher, naperville, shahirizada"
  },
  announcement: "🚀 New feature alert: AI Analytics is now live!",
  newsletter: true,
  loyalty: {
    enabled: true,
    earnPerDollar: 10,
